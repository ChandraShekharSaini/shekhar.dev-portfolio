      ...
      <div className="flex justify-center flex-col w-4/5 m-auto h-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-12 ">
          <div className="">
            ...
            <h1 className="text-bg text-3xl sm:text-4xl md:text-5xl lg:text-6xl   font-bold md:leading-[3rem] lg:leading-[3.5rem] xl:leading-[4rem] text-white">
              {BaseInfo.position}
            </h1>
          ...
          <div className="mx-auto hidden lg:block rounded-[3rem] border-[3px] border-blue-950 overflow-x-hidden">
            <Image
